  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center">
      <div className="glass-strong rounded-3xl p-6">
        <div className="mb-2 text-xs font-semibold text-slate-500 dark:text-slate-400">Signup</div>
        <h2 className="text-2xl font-black text-slate-900 dark:text-slate-50">Start tracking.</h2>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Demo signup UI (frontend only).</p>
        ...
        <div className="mt-4 text-center text-sm text-slate-600 dark:text-slate-300">
          ...
          <Link className="font-semibold text-sky-600 dark:text-sky-400" to="/login">
            Login
          </Link>
        </div>
      </div>
